package android.webinnovatives.com.expandablelistviewchecker;
...
public class MyCategoriesExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    static ArrayList<ArrayList<HashMap<String, String>>> childItems = new ArrayList<>();
    static ArrayList<HashMap<String, String>> parentItems = new ArrayList<>();
    ...
    public View getGroupView(final int groupPosition, final boolean b, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            if (isFromMyCategoriesFragment) {
                convertView = inflater.inflate(R.layout.my_category, null);
            } else {
